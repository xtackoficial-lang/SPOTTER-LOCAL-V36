...
check(
  "Pro com 9/10 + 5 ficheiros → aceita só 1, resto bloqueado",
  sim.accepted === 1 && sim.blocked === true,
);
...
check(
  "mostra exatamente as 10 primeiras, não apaga as outras 10 do array original",
  galeriaCom20Fotos.length === 20,
);
