...
export const CATEGORY_FILTERS = [
  ...
  { id: "auto_repair", label: "Oficinas", icon: "auto_repair" },
  { id: "car_wash", label: "Lavagens", icon: "car_wash" },
  { id: "gym", label: "Ginásios", icon: "gym" },
  { id: "bakery", label: "Padarias", icon: "bakery" },
  { id: "hardware_store", label: "Construção", icon: "hardware_store" },
